    ...
    let mut tools = json!([
        ...
        },
        {
            ...
            "inputSchema": object(json!({
                ...
                "priority": {"type": "integer", "minimum": 1, "maximum": 3, "description": "Tasks only: 1 normal, the default; 2 medium; 3 high, the most urgent."},
        ...
        },
        {
            ...
            "inputSchema": object(json!({
                ...
                "if_updated_at": {"type": "integer"},
                "priority": {"type": "integer", "minimum": 1, "maximum": 3, "description": "1 normal, the default; 2 medium; 3 high, the most urgent."},
